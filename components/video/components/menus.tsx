...
export function Captions({
  ...
  const options = useCaptionOptions({ off: t("off_captions") });
  const hint = options.selectedTrack?.label ?? t("off_captions");

  return (
    <DropdownMenu.Root>
      <Tooltip.Root>
        <Tooltip.Trigger asChild>
          <DropdownMenu.Trigger aria-label="Settings" className={buttonClass} disabled={options.disabled}>
      ...
      >
        ...
        <DropdownMenu.RadioGroup aria-label="Captions" className="w-full flex flex-col" value={options.selectedValue}>
